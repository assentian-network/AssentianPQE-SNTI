...
std::string DeploymentName(Consensus::BuriedDeployment dep)
{
    ...
    case Consensus::DEPLOYMENT_SEGWIT:
        return "segwit";
    case Consensus::DEPLOYMENT_XMSSSPENDLEAFREUSE:
        return "xmssspendleafreuse";
...
std::optional<Consensus::BuriedDeployment> GetBuriedDeployment(const std::string_view name)
{
    ...
    } else if (name == "xmssspendleafreuse") {
        return Consensus::BuriedDeployment::DEPLOYMENT_XMSSSPENDLEAFREUSE;
    }
    return std::nullopt;
}
