...
public:
    ...
    virtual bool CheckXMSSSignature(const std::vector<unsigned char>& sig, const std::vector<unsigned char>& pubkey, const CScript& scriptCode, SigVersion sigversion) const
    {
        return false;
    }
...
public:
    ...
    bool CheckXMSSSignature(const std::vector<unsigned char>& sig, const std::vector<unsigned char>& pubkey, const CScript& scriptCode, SigVersion sigversion) const override;
